    ...
    <div className="flex flex-col w-full max-w-[1440px] mx-auto px-6 md:px-10 mt-12 pb-12 flex-1">
      <div className="flex flex-col gap-2 mb-10">
        ...
        <p className="text-[16px] text-white/70 font-medium">
          Hourly and extended 10-day outlook for {location?.name || 'your location'}.
        </p>
      </div>

      <div className="w-full mb-12">
        <h2 className="text-[20px] font-[700] text-white tracking-tight mb-6 ml-2">Next 24 Hours</h2>
        <HourlyForecast />
      </div>

      <div className="w-full max-w-4xl">
        <h2 className="text-[20px] font-[700] text-white tracking-tight mb-6 ml-2">10-Day Outlook</h2>
        <div className="bg-[rgba(10,15,25,0.55)] backdrop-blur-[12px] border border-[rgba(255,255,255,0.04)] rounded-[24px] shadow-[0_20px_50px_rgba(0,0,0,0.25)] border-t-[rgba(255,138,61,0.25)] p-6 md:p-10 flex flex-col gap-4 relative overflow-hidden">
